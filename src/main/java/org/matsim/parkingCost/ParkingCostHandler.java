...
package org.matsim.parkingCost;
...
final class ParkingCostHandler implements ActivityEndEventHandler, PersonDepartureEventHandler, PersonLeavesVehicleEventHandler, PersonEntersVehicleEventHandler {
	
	private Map<Id<Person>, Double> personId2lastLeaveVehicleTime = new HashMap<>();
	private Map<Id<Person>, String> personId2previousActivity = new HashMap<>();
	private Map<Id<Person>, Id<Link>> personId2relevantModeLinkId = new HashMap<>();
