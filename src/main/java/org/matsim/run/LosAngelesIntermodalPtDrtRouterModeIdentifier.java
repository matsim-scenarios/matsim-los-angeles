 ...
 *
 */
public final class LosAngelesIntermodalPtDrtRouterModeIdentifier implements AnalysisMainModeIdentifier {
	private final List<String> modeHierarchy = new ArrayList<>() ;
	private final List<String> drtModes;

	@Inject
	public LosAngelesIntermodalPtDrtRouterModeIdentifier() {
		...
		modeHierarchy.add( "bike" ); // TransportMode.bike is not registered as main mode, only "bicycle" ;
